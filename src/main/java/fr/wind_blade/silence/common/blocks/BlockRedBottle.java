...
public class BlockRedBottle extends BlockGenericDecoration implements IMetaProvider {
	...
	public BlockRedBottle(Material materialIn) {
		super(materialIn);
	}
	...
	public IBlockState getStateForPlacement(World world, BlockPos pos, EnumFacing facing, float hitX, float hitY,
		...
		return super.getStateForPlacement(world, pos, facing, hitX, hitY, hitZ, meta, placer, hand).withProperty(VARIANT, Type.getFromMeta(meta));
	}
